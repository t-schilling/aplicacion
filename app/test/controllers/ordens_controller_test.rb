...
class OrdensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden" do
    assert_difference('Orden.count') do
      post ordens_url, params: { orden: { direccion: @orden.direccion, estado: @orden.estado, info: @orden.info, llegada: @orden.llegada, pago: @orden.pago, plato: @orden.plato, precio: @orden.precio } }
    end
  ...
  test "should update orden" do
    patch orden_url(@orden), params: { orden: { direccion: @orden.direccion, estado: @orden.estado, info: @orden.info, llegada: @orden.llegada, pago: @orden.pago, plato: @orden.plato, precio: @orden.precio } }
